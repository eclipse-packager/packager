...
public class CpioArchiveInputStream extends ArchiveInputStream<CpioArchiveEntry> implements CpioConstants {
     ...
     * @since 1.28
     */
    public CpioArchiveInputStream(final InputStream in, final List<Long> fileSizes) {
     ...
     * @since 1.28
     */
    public CpioArchiveInputStream(final InputStream in, final int blockSize, final List<Long> fileSizes) {
     ...
     * @since 1.28
     */
    public CpioArchiveInputStream(final InputStream in, final int blockSize, final String encoding, final List<Long> fileSizes) {
        super(in, encoding);
        this.in = in;
        if (blockSize <= 0) {
     ...
     * @since 1.28
     */
    public CpioArchiveInputStream(final InputStream in, final String encoding, final List<Long> fileSizes) {
